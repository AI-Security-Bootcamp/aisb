...
# Day 6 — Section 3: Prefix Tuning in Embedding Space
...
- [Prefix Tuning in Embedding Space](#prefix-tuning-in-embedding-space-1)
    - [Exercise 6.3.1: Set Up the Model and Prompt Context](#exercise-631-set-up-the-model-and-prompt-context)
    - [Exercise 6.3.2: Initialize a Latent Prefix and Score It Against the Batch](#exercise-632-initialize-a-latent-prefix-and-score-it-against-the-batch)
    - [Exercise 6.3.3: Optimize the Latent Prefix](#exercise-633-optimize-the-latent-prefix)
...
Create a file named `day6_answers.py` in the `6.3-prefix-tuning` directory. This will be your answer file for this
section.
...
### Exercise 6.3.1: Set Up the Model and Prompt Context
