...
# Day 5 — Section 2: Fine-Tuning Data Poisoning and Backdoors
...
- [Backdoor Attack via Instruction Tuning Poisoning](#backdoor-attack-via-instruction-tuning-poisoning)
    - [Setup](#setup)
    - [Exercise 5.2.1: Generate the Poisoned Dataset](#exercise-521-generate-the-poisoned-dataset)
    - [Exercise 5.2.2: Create Train and Evaluation Splits](#exercise-522-create-train-and-evaluation-splits)
    - [Exercise 5.2.3: Tokenize the Training Data](#exercise-523-tokenize-the-training-data)
    - [Exercise 5.2.4: Create the Data Collator](#exercise-524-create-the-data-collator)
    ...
    - [Exercise 5.2.5: Fine-Tune the Model](#exercise-525-fine-tune-the-model)
    - [Aside: What `Trainer` Does Under the Hood](#aside-what-trainer-does-under-the-hood)
    - [Exercise 5.2.6: Test the Backdoor](#exercise-526-test-the-backdoor)
- [Summary](#summary)
...
- **5.2.1:** Build the poisoned chat dataset
- **5.2.2:** Create train and evaluation splits
- **5.2.3:** Tokenize the training data
- **5.2.4:** Create a causal language modeling data collator
- **5.2.5:** Fine-tune with Hugging Face `Trainer`
- **5.2.6:** Test the backdoor


### Setup

Create a file named `day5_answers.py` in the `5.2-backdooring` directory. This will
...
### Exercise 5.2.1: Generate the Poisoned Dataset
...
### Exercise 5.2.2: Create Train and Evaluation Splits
...
### Exercise 5.2.3: Tokenize the Training Data
...
### Exercise 5.2.4: Create the Data Collator
...
### Exercise 5.2.5: Fine-Tune the Model
...
Configure the trainer to evaluate on the eval split from Exercise 5.2.2 once per
...
### Exercise 5.2.6: Test the Backdoor
