...
# Day 2 — Section 4: Bonus: From Monitor Scores to System Safety
...
- [Bonus: From Monitor Scores to System Safety](#bonus-from-monitor-scores-to-system-safety)
    - [Exercise 2.4.1: Explore the Safety Simulator](#exercise-241-explore-the-safety-simulator)
- [Summary](#summary)
...
### Exercise 2.4.1: Explore the Safety Simulator
