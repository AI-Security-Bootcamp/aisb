...
# Day 6 — Section 1: Adversarial Attacks on Vision Models
...
- [Adversarial Attacks on Vision Models](#adversarial-attacks-on-vision-models-1)
    - [Exercise 6.1.1: Understanding Model Predictions](#exercise-611-understanding-model-predictions)
    - [Exercise 6.1.2a: Adding Random Noise (Optional)](#exercise-612a-adding-random-noise-optional)
    - [Exercise 6.1.2b: Crafting Adversarial Examples](#exercise-612b-crafting-adversarial-examples)
        - [Questions to consider](#questions-to-consider)
    - [Exercise 6.1.3: Constrained Adversarial Attacks](#exercise-613-constrained-adversarial-attacks)
...
Create a file named `day6_answers.py` in the `6.1-adversarial-vision` directory. This will be your answer file for
today's section.
...
### Exercise 6.1.1: Understanding Model Predictions
...
### Exercise 6.1.2a: Adding Random Noise (Optional)
...
### Exercise 6.1.2b: Crafting Adversarial Examples
...
### Exercise 6.1.3: Constrained Adversarial Attacks
