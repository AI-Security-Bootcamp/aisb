...
Create a file named `6.1_answers.py` in the `6.1-adversarial-vision` directory. This will be your answer file for
today's section.
...
**Start by pasting the code below in your 6.1_answers.py file.**
"""
...
def test_constrained_adversarial_attack(solution):
    ...
    model = scope["model"]
    image = scope["image"]
    target_class_id = scope["target_class_id"]
