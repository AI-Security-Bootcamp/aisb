...
- [RAND framework: understanding the threat landscape](#rand-framework-understanding-the-threat-landscape)
    - [Exercise 7.1.1: Operational Capability Classification](#exercise-711-operational-capability-classification)
    - [Exercise 7.1.2: Security Level Mapping](#exercise-712-security-level-mapping)
- [Summary](#summary)
