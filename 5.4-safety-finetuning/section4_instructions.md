...
# Day 5 — Section 4: Undoing Safety Fine-tuning with LoRA (Optional)

> **Optional:** This alternative LoRA safety-removal exercise is retained
> for reference. Section 5.3 is the current exercise and directly studies
...
- [Undoing Safety Fine-tuning](#undoing-safety-fine-tuning)
    - [Setup](#setup)
    - [Exercise 5.4.1: Prepare and Cache the Dataset](#exercise-541-prepare-and-cache-the-dataset)
    - [Exercise 5.4.2: Train the LoRA Adapter](#exercise-542-train-the-lora-adapter)
    - [Exercise 5.4.3: Evaluate Refusal Rate](#exercise-543-evaluate-refusal-rate)
- [Summary](#summary)
...
If you have not already, create a file named `day5_answers.py` in the `5.4-safety-finetuning`
...
**Paste the boilerplate below into your `day5_answers.py` file.**
...
### Exercise 5.4.1: Prepare and Cache the Dataset
...
### Exercise 5.4.2: Train the LoRA Adapter
...
### Exercise 5.4.3: Evaluate Refusal Rate
...
Across Day 5, you saw four ways to corrupt or modify a deployed model:
