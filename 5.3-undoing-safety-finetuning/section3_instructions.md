...
- [1. Finding the refusal direction](#1-finding-the-refusal-direction-1)
    ...
    - [Exercise 5.3.1: Residual stream hook function](#exercise-531-residual-stream-hook-function)
    - [Exercise 5.3.2: Capture mean activations](#exercise-532-capture-mean-activations)
...
- [2. Bypassing refusal (directional ablation)](#2-bypassing-refusal-directional-ablation-1)
    - [Exercise 5.3.3: Project out a direction](#exercise-533-project-out-a-direction)
    - [Exercise 5.3.4: Ablate the direction during generation](#exercise-534-ablate-the-direction-during-generation)
- [3. Inducing refusal (activation addition)](#3-inducing-refusal-activation-addition-1)
    - [Exercise 5.3.5: Steering hook](#exercise-535-steering-hook)
- [4. Baking it into the weights](#4-baking-it-into-the-weights-1)
    - [Exercise 5.3.6: Abliterate the model](#exercise-536-abliterate-the-model)
- [5. (Optional) Measuring the cost](#5-optional-measuring-the-cost)
    - [Exercise 5.3.7: Map a dataset record to an Inspect `Sample`](#exercise-537-map-a-dataset-record-to-an-inspect-sample)
