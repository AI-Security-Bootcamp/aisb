...
# Day 6 — Section 4: Image Watermarking in Diffusion Models (Optional)
...
- [Image Watermarking in Diffusion Models](#image-watermarking-in-diffusion-models-1)
    - [Exercise 6.4.1: Setting Up Stable Diffusion](#exercise-641-setting-up-stable-diffusion)
    - [Exercise 6.4.2: Implementing Frequency-Domain Watermarking](#exercise-642-implementing-frequency-domain-watermarking)
    - [Exercise 6.4.3: Analyzing Watermarks with FFT](#exercise-643-analyzing-watermarks-with-fft)
    - [Exercise 6.4.4: Testing Watermark Robustness](#exercise-644-testing-watermark-robustness)
...
### Exercise 6.4.1: Setting Up Stable Diffusion
...
### Exercise 6.4.2: Implementing Frequency-Domain Watermarking
...
### Exercise 6.4.3: Analyzing Watermarks with FFT
...
### Exercise 6.4.4: Testing Watermark Robustness
...
Congratulations! You've completed the optional Day 6 watermarking section. Across Day 6, you've learned:
