...
# Day 4 — Section 3: Undoing Safety Fine-tuning
...
- [1. Finding the refusal direction](#1-finding-the-refusal-direction-1)
    ...
    - [Exercise 4.3.1: Residual stream hook function](#exercise-431-residual-stream-hook-function)
    - [Exercise 4.3.2: Capture mean activations](#exercise-432-capture-mean-activations)
...
- [2. Bypassing refusal (directional ablation)](#2-bypassing-refusal-directional-ablation-1)
    - [Exercise 4.3.3: Project out a direction](#exercise-433-project-out-a-direction)
    - [Exercise 4.3.4: Ablate the direction during generation](#exercise-434-ablate-the-direction-during-generation)
- [3. Inducing refusal (activation addition)](#3-inducing-refusal-activation-addition-1)
    - [Exercise 4.3.5: Steering hook](#exercise-435-steering-hook)
- [4. Baking it into the weights](#4-baking-it-into-the-weights-1)
    - [Exercise 4.3.6: Abliterate the model](#exercise-436-abliterate-the-model)
- [5. (Optional) Measuring the cost](#5-optional-measuring-the-cost)
    - [Exercise 4.3.7: Map a dataset record to an Inspect `Sample`](#exercise-437-map-a-dataset-record-to-an-inspect-sample)
...
Create a file named `day4_answers.py` in the `4.3-undoing-safety-finetuning` directory. This will
...
### Exercise 4.3.1: Residual stream hook function
...
### Exercise 4.3.2: Capture mean activations
...
### Exercise 4.3.4: Ablate the direction during generation
...
### Exercise 4.3.6: Abliterate the model
...
### Exercise 4.3.7: Map a dataset record to an Inspect `Sample`
