...
- [Content & Learning Objectives](#content--learning-objectives)
    - [4️⃣ Image Watermarking in Diffusion Models](#4️⃣-image-watermarking-in-diffusion-models)
- [Setup](#setup)
- [4️⃣ Image Watermarking in Diffusion Models](#4️⃣-image-watermarking-in-diffusion-models-1)
...
### 4️⃣ Image Watermarking in Diffusion Models
...
Create a file named `section4_answers.py` in the `4-watermarking` directory. This will be your answer file for this
section.
