...
- [The Key](#the-key)
    - [Exercise 5.4.1: The Ring Mask](#exercise-541-the-ring-mask)
    - [Exercise 5.4.2: Plant the Key in a Latent](#exercise-542-plant-the-key-in-a-latent)
    - [Exercise 5.4.3: Watermarked Initial Noise](#exercise-543-watermarked-initial-noise)
- [Detection by Inversion (given)](#detection-by-inversion-given)
    - [DDIM Inversion (given)](#ddim-inversion-given)
    - [Exercise 5.4.4: Distance to the Key](#exercise-544-distance-to-the-key)
- [Calibrated Detection](#calibrated-detection)
    - [Exercise 5.4.5: Threshold and Detector](#exercise-545-threshold-and-detector)
- [Robustness](#robustness)
    - [Detection Under Perturbation](#detection-under-perturbation)
...
- [How Many Keys Are There?](#how-many-keys-are-there)
- [Summary](#summary)
