...
- [Content & Learning Objectives](#content--learning-objectives)
    - [Image Watermarking in Diffusion Models](#image-watermarking-in-diffusion-models)
- [Setup](#setup)
- [Image Watermarking in Diffusion Models](#image-watermarking-in-diffusion-models-1)
    - [Exercise 5.4.1: Setting Up Stable Diffusion](#exercise-541-setting-up-stable-diffusion)
    - [Exercise 5.4.2: Implementing Frequency-Domain Watermarking](#exercise-542-implementing-frequency-domain-watermarking)
    - [Exercise 5.4.3: Analyzing Watermarks with FFT](#exercise-543-analyzing-watermarks-with-fft)
    - [Exercise 5.4.4: Testing Watermark Robustness](#exercise-544-testing-watermark-robustness)
...
from section4_test import test_watermark_hook
