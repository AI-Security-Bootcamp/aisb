...
- [Adversarial Examples in Language Models](#adversarial-examples-in-language-models-1)
    ...
    - [Exercise 6.2.2: Use Gradients to Propose Token Replacements](#exercise-622-use-gradients-to-propose-token-replacements)
    - [Exercise 6.2.3: Run the Full GCG Loop](#exercise-623-run-the-full-gcg-loop)
...
### Exercise 6.2.1: Score a Target Continuation
